...
Route::middleware('auth:siswa')->group(function () {
    ...
    Route::post('/laporan/{aspirasi}/feedback',
    [LaporanPengaduanController::class, 'feedback'])->name('laporan.feedback');
    Route::resource('/laporan', LaporanPengaduanController::class)
