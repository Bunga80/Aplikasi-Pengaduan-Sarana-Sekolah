    ...
    <form class="card-body" method="POST" action="{{ route('siswa.register') }}">
        ...
        <div class="mb-3">
            <div class="input-group">
                ...
                <input type="text" name="nis" class="form-control @error('nis') is-invalid @enderror" placeholder="NIS" value="{{ old('nis', $nis) }}">
            </div>
            @error('nis')
        ...
        <div class="mb-3">
            <div class="input-group">
                ...
                <input type="text" name="kelas" class="form-control @error('kelas') is-invalid @enderror" placeholder="Kelas (contoh: X PPLG A" value="{{ old('kelas') }}">
            </div>
            @error('kelas')
            <div class="invalid-feedback d-block">
                {{ $message }}
